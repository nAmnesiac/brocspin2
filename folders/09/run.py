...
gpu_id = "0"
top_inp, param_inp = 'param3.inp', 'top3.inp'

# input parameters
parser = argparse.ArgumentParser()
parser.add_argument('-c', "--pdb", default='complex.pdb', help="pdb file, default is conf.pdb")
parser.add_argument('-p', "--psf", default='complex.psf', help="psf file, default is conf.psf")
...
apotential_energy = simulation.context.getState(getEnergy=True).getPotentialEnergy()
akinetic_energy = simulation.context.getState(getEnergy=True).getKineticEnergy()
print('before: ', apotential_energy + akinetic_energy)
print('potential: ', apotential_energy)
print('kinetic: ', akinetic_energy)

simulation.minimizeEnergy(maxIterations=500000, tolerance=0.01)

apotential_energy = simulation.context.getState(getEnergy=True).getPotentialEnergy()
akinetic_energy = simulation.context.getState(getEnergy=True).getKineticEnergy()
print('after: ', apotential_energy + akinetic_energy)
print('potential: ', apotential_energy)
print('kinetic: ', akinetic_energy)
