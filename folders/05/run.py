...
gpu_id = "0"
top_inp, param_inp = 'param.inp', 'top.inp'

# input parameters
parser = argparse.ArgumentParser()
parser.add_argument('-c', "--pdb", default='structures/CG_pdb/dfhbi_CG.pdb', help="pdb file, default is conf.pdb")
parser.add_argument('-p', "--psf", default='structures/psf/dfhbi_CG2.psf', help="psf file, default is conf.psf")
...
# with open(f'{base_name}_bm.pdb', 'w') as f:
